package com.train.learn.controller;
...
public class FileChunkUploadController {
    // 文件临时目录，用于保存上传的分片文件
    private static final String TEMP_DIR = "C:\\Users\\Y9000P\\OneDrive\\桌面\\test\\temp\\";

    // 文件上传目录，用于保存合并后的文件
    private static final String UPLOAD_DIR = "C:\\Users\\Y9000P\\OneDrive\\桌面\\test\\upload\\";
